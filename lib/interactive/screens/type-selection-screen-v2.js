...
class TypeSelectionScreenV2 extends ComponentScreen {
  constructor(options) {
    const types = [
  ...
  navigateToSecretSelection(selectedType, choices) {
    ...
    const secretScreen = new SecretSelectionScreenV2({
      selectedType,
      choices,
...
module.exports = { TypeSelectionScreenV2 };