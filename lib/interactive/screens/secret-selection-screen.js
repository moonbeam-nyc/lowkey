...
class SecretSelectionScreen extends ComponentScreen {
  constructor(options) {
    ...
    // Question text - use description for display if available
    const displayName = selectedType.description || selectedType.name;
    this.question = `Select ${displayName} secret:`;
  }
