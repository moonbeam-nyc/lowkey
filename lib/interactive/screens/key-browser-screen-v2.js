...
class KeyBrowserScreenV2 extends ComponentScreen {
  constructor(options) {
    super({
      id: 'key-browser-v2',
    ...
    const handlers = this.createKeyHandlers()
      ...
      .onKey('\u0016', () => { // Ctrl+V
        ...
        this.setState({ 
          ...
          successMessage: showValues ? 'Values hidden' : 'Values shown'
        });
  ...
  async launchCopyWizard(filteredKeys = null) {
    try {
      ...
      const wizardScreen = new CopyWizardScreenV2({
...
module.exports = { KeyBrowserScreenV2 };