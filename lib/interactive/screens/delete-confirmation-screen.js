...
class DeleteConfirmationPopup extends BasePopup {
  ...
  renderModalContent() {
    ...
    if (this.deleteSuccess) {
      ...
      const successWidth = Math.max(40, this.secretName.length + 25);
      ...
      lines.push(this.buildModalLine(`${colorize('✓', 'green')} ${this.secretName} deleted successfully`, successWidth)); // Line 4
