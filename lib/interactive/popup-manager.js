...
class PopupManager {
  ...
  render() {
    ...
    try {
      ...
      // Get base screen content - handle both component-based and legacy screens
      let baseContent = '';
      if (this.baseScreen.getComponents) {
        ...
        // Temporarily clear screen and capture the full render with header
        ...
        debugLogger.log('Used component renderer with header for base content');
