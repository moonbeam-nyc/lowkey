  ...
  async performCopy() {
    ...
    try {
      ...
      if (outputType === 'kubernetes') {
        ...
        // Navigate to the newly created secret instead of showing success
        this.navigateToNewSecret(outputName, outputNamespace);
        return; // Don't set step to 'done'
      } else {
        ...
        // Navigate to the newly created file instead of showing success
